    ...
    <div className="addcar">
      ...
      <div className="addcar__infoBox">
        ...
        <form className="addcar__option" onSubmit={handleSubmit}>
          ...
          />
          {errors.name && <span className="login__inputFeedback">{errors.name}</span>}
          <p>Model</p>
          {/* <input
                  type="text"
                  name="email"
          ...
          <input
            ...
            onChange={handleChange}
          />
          {errors.type && <span className="login__inputFeedback">{errors.type}</span>}
          ...
          {errors.personCapacity && (
            <span className="login__inputFeedback">{errors.personCapacity}</span>
          )}
