...
const headCells = [
  ...
  { id: "fuelType", numeric: true, disablePadding: false, label: "Fuel" },
  { id: "gearType", numeric: true, disablePadding: false, label: "Gear" },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.personCapacity}</TableCell>
                      <TableCell align="right">{row.bagCapacity}</TableCell>
                      <TableCell align="right">{row.fuelType}</TableCell>
                      <TableCell align="right">{row.gearType}</TableCell>
